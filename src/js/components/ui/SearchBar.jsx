...
export default function SearchBar({handleSearch}) {
  return (
    ...
    <div class="relative overflow-hidden rounded-2xl">
        ...
        type="search" name="title" id="default-search" class="block w-full p-2 ps-32  border-solid border-2 border-c-black rounded-2xl" placeholder="Qué quieres aprender hoy?" required />
        <button 
